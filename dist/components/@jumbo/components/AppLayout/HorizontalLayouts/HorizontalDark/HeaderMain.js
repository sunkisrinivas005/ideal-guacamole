...
var _GlobalSearchForm = _interopRequireDefault(require("../../partials/GlobalSearchForm"));
...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  ...
  return {
    root: {
      ...
      minHeight: 10,
      padding: 0,
      '& .Cmt-appIcon': (0, _defineProperty2.default)({}, theme.breakpoints.down('xs'), {
        padding: 7
      })
    },
    langRoot: (_langRoot = {
      ...
      height: 35,
      width: 1,
      backgroundColor: (0, _core.alpha)(theme.palette.common.dark, 0.15)
    }), _langRoot),
...
var HeaderMain = function HeaderMain() {
  ...
  return /*#__PURE__*/_react.default.createElement(_Toolbar.default, {
    ...
    smDown: true
  }, /*#__PURE__*/_react.default.createElement(_GlobalSearchForm.default, null)), /*#__PURE__*/_react.default.createElement(_core.Box, {
    display: "flex",
    alignItems: "center",
    ml: "auto"
  }, /*#__PURE__*/_react.default.createElement(_Hidden.default, {
