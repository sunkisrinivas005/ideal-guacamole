...
var _GlobalSearchForm = _interopRequireDefault(require("../../GlobalSearchForm"));
  ...
  return {
    root: {
      ...
      '& .Cmt-appIcon': (0, _defineProperty2.default)({
        ...
        '&:hover, &:focus': {
          color: (0, _styles.darken)(theme.palette.text.secondary, 0.2)
        }
...
var HeaderTop = function HeaderTop() {
  ...
  return /*#__PURE__*/_react.default.createElement(_Toolbar.default, {
    ...
    smDown: true
  }, /*#__PURE__*/_react.default.createElement(_GlobalSearchForm.default, null)), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      marginLeft: 'auto'
