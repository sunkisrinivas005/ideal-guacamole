...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  ...
  return {
    ...
    formcontrolLabelRoot: {
      '& .MuiFormControlLabel-label': (0, _defineProperty2.default)({}, theme.breakpoints.down('xs'), {
        fontSize: 12
      })
    }
  };
...
var SignIn = function SignIn(_ref) {
  ...
  var _useState3 = (0, _react.useState)('demo#123'),
  ...
  var onSubmit = function onSubmit() {
    dispatch(_auth.AuhMethods[method].onLogin({
      email: email,
      password: password
    }));
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_AuthWrapper.default, {
  ...
  }, "Login"), /*#__PURE__*/_react.default.createElement("form", null, /*#__PURE__*/_react.default.createElement(_core.Box, {
    mb: 2
    ...
    id: "signIn.signUp"
  }))))), dispatch(_auth.AuhMethods[method].getSocialMediaIcons()), /*#__PURE__*/_react.default.createElement(_ContentLoader.default, null)));
};
